...
- use the contents of the ascii_data folder to associate each of the resulting reduced palette colors with an ascii character. This is done by dividing the reduced palette image into blocks of 8 x 16 pixels and replacing each block with the ascii character associated with the block's dominant color.
